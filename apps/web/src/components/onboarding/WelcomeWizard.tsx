 ...
 * onboarding overhaul spec: local environment choice →
  ...
  return (
    <>
      ...
      <p className="mt-2.5 text-sm leading-relaxed text-muted-foreground">
        Choose the local environments where your agents and projects will run.
      </p>
      <fieldset className="mt-5 space-y-2">
        <legend className="sr-only">Local environments</legend>
